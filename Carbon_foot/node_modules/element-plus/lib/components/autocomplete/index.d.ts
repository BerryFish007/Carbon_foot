export declare const ElAutocomplete: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    popperRef: import("vue").Ref<({
        ...
        ElTooltipContent: import("vue").DefineComponent<{
            ...
            readonly appendTo: {
                readonly type: import("vue").PropType<import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => (string | HTMLElement) & {}) | (() => string | HTMLElement) | ((new (...args: any[]) => (string | HTMLElement) & {}) | (() => string | HTMLElement)